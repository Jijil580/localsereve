...
const hindi = withEnglish({
  ...
  passwordPlaceholder: "कम से कम 8 अक्षर", passwordHint: "बड़े और छोटे अक्षर तथा कम से कम एक अंक उपयोग करें।",
...
const tamil = withEnglish({
  ...
  passwordPlaceholder: "குறைந்தது 8 எழுத்துகள்", passwordHint: "பெரிய எழுத்து, சிறிய எழுத்து மற்றும் ஒரு எண்ணையாவது பயன்படுத்தவும்.",
...
const kannada = withEnglish({
  ...
  passwordPlaceholder: "ಕನಿಷ್ಠ 8 ಅಕ್ಷರಗಳು", passwordHint: "ದೊಡ್ಡಕ್ಷರ, ಸಣ್ಣಕ್ಷರ ಮತ್ತು ಕನಿಷ್ಠ ಒಂದು ಸಂಖ್ಯೆಯನ್ನು ಬಳಸಿ.",
...
const telugu = withEnglish({
  ...
  passwordPlaceholder: "కనీసం 8 అక్షరాలు", passwordHint: "పెద్ద అక్షరం, చిన్న అక్షరం మరియు కనీసం ఒక సంఖ్యను ఉపయోగించండి.",
