const english = {
  ...
  profileDashboard: "Profile and dashboard", manageAccount: "Manage your Nearlio account", changeLocation: "Change location",
  ...
  exploreCategories: "Explore categories", topNearby: "Top professionals near you", realProfessionals: "Real professionals published after Nearlio admin review.",
  ...
  availabilityUnknown: "Availability not confirmed", reviewed: "ID & profile reviewed", newNearlio: "New on Nearlio",
  noReviews: "No customer reviews yet", startsFrom: "Starts from", askEstimate: "Ask for an estimate", noJobs: "No completed jobs yet",
  customers: "Customers", safety: "Safety", professionals: "Professionals", joinNearlio: "Join Nearlio", plansPricing: "Plans & pricing",
  ...
  welcome: "Welcome to Nearlio", signInAccount: "Sign in to your account", createNearlioAccount: "Create your Nearlio account",
  ...
  consent: "I agree to the Nearlio User Terms and Privacy Notice, including the rules against unwanted messages and misuse of contact details.",
...
const malayalam: { [K in keyof typeof english]: string } = {
  ...
  profileDashboard: "പ്രൊഫൈലും ഡാഷ്ബോർഡും", manageAccount: "Nearlio അക്കൗണ്ട് നിയന്ത്രിക്കുക", changeLocation: "സ്ഥലം മാറ്റുക",
  ...
  exploreCategories: "വിഭാഗങ്ങൾ പരിശോധിക്കുക", topNearby: "നിങ്ങളുടെ സമീപത്തെ മികച്ച പ്രൊഫഷണലുകൾ", realProfessionals: "Nearlio അഡ്മിൻ പരിശോധിച്ച് പ്രസിദ്ധീകരിച്ച യഥാർത്ഥ പ്രൊഫഷണലുകൾ.",
  ...
  availabilityUnknown: "ലഭ്യത സ്ഥിരീകരിച്ചിട്ടില്ല", reviewed: "ഐഡിയും പ്രൊഫൈലും പരിശോധിച്ചു", newNearlio: "Nearlio-യിൽ പുതിയത്",
  ...
  customers: "ഉപഭോക്താക്കൾ", safety: "സുരക്ഷ", professionals: "പ്രൊഫഷണലുകൾ", joinNearlio: "Nearlio-യിൽ ചേരുക", plansPricing: "പ്ലാനുകളും നിരക്കുകളും",
  ...
  welcome: "Nearlio-യിലേക്ക് സ്വാഗതം", signInAccount: "നിങ്ങളുടെ അക്കൗണ്ടിൽ ലോഗിൻ ചെയ്യുക", createNearlioAccount: "Nearlio അക്കൗണ്ട് സൃഷ്ടിക്കുക",
  ...
  consent: "അനാവശ്യ സന്ദേശങ്ങളും ബന്ധപ്പെടാനുള്ള വിവരങ്ങളുടെ ദുരുപയോഗവും നിരോധിക്കുന്ന Nearlio ഉപയോക്തൃ നിബന്ധനകളും സ്വകാര്യതാ അറിയിപ്പും ഞാൻ അംഗീകരിക്കുന്നു.",
