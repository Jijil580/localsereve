...
export async function GET(request: Request) {
  ...
  try {
    ...
    const response = await fetch(url, { headers: { "user-agent": "Nearlio/1.0 (https://localserviecses.vercel.app)", "accept-language": "en-IN,en;q=0.9" }, next: { revalidate: 2_592_000 } });
