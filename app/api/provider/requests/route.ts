  ...
  try {
    ...
    return Response.json({
      ...
      data: nearbyRows.map(row => ({
        ...
        customerCompletionConfirmedAt: row.customerCompletionConfirmedAt,
        providerCompletionConfirmedAt: row.providerCompletionConfirmedAt,
        paymentGivenAt: row.paymentGivenAt,
