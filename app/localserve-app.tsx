...
export default function NearleoApp() {
  ...
  return (
    <div className="app-shell">
      ...
      <nav className="mobile-nav premium-mobile-nav" aria-label="Mobile navigation">{[["home",t.home,"home"],["requests",t.requests,"requests"],["messages",t.messages,"messages"],["account",t.account,"dashboard"]].map(([icon,label,id]) => <button aria-current={view===id ? "page" : undefined} className={view===id ? "active" : ""} onClick={() => id==="messages"?openMessages():(["requests","dashboard"].includes(id) ? openProtected(id as View) : navigate(id as View))} key={id}><span><MobileNavIcon name={icon}/></span>{label}</button>)}</nav>
