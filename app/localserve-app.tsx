...
export default function NearleoApp() {
  ...
  return (
    <div className="app-shell">
      ...
      {selected && !modal && <ProviderDrawer provider={selected} user={currentUser} saved={saved.includes(selected.id)} onClose={() => setSelected(null)} onBook={() => setModal("booking")} onSignIn={openContactSignIn} onLikeUpdate={updateProviderLike} onSave={() => toggleSavedProvider(selected.id)} />}
